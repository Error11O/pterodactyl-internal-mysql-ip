...
export default ({ database, className }: Props) => {
    ...
    }@${database.internal_address ?? database.host}:${database.port}/${database.name}`;
        ...
        <>
            ...
            <Modal visible={connectionVisible} onDismissed={() => setConnectionVisible(false)}>
                ...
                <div>
                    ...
                    <CopyOnClick text={`${database.internal_address ?? database.host}:${database.port}`}>
                        <Input type={'text'} readOnly value={`${database.internal_address ?? database.host}:${database.port}`} />
                    </CopyOnClick>
                </div>
                <div css={tw`mt-6`}>
            ...
            <tr className={className}>
                ...
                <td>
                    <CopyOnClick text={`${database.internal_address ?? database.host}:${database.port}`}>
                        <p>{database.internal_address ?? database.host}:{database.port}</p>
                    </CopyOnClick>
                </td>
                <td className={'w-1'}>
